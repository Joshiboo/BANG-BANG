...
function anteriorPersonaje(){
    ...
    //If para regresar en contador en caso de llegar a 0
    if (personajeActual < 1){
        personajeActual = 6;
    }

    //Asignar personaje con el docmuent.getElement
    document.getElementById('personaje').src="img/p"+personajeActual+".png"
    var sfxclic = new Audio ('sfx/clic.mp3');
    sfxclic.play();
}
...
function cargarEscenario(){
    ...
    //cargar nombres de los jugadores
